...
namespace Стамотология
{
    public partial class FormДоговор : Form
    {
        ...
        private void FormДоговор_Load(object sender, EventArgs e)
        {
            ...
            {
                //queryNumber = "select top " + num.ToString() + " НомерДоговора from Договор order by НомерДоговора asc";
            ...
            //string nn = tabNum.Rows[Convert.ToInt32(num-1)]["НомерДоговора"].ToString();
            //DataRow r = tabNum.Rows[Convert.ToInt32(num-1)];
        ...
        {            
            ...
            //{
                ...
                if (this.flagPrintДопСоглашение == false)
                {
                    ...
                    //Адрес
                    string улица = rP["улица"].ToString();
